include(dataModelsRoot + 'DataModel.js');

include(dataModelsRoot + 'lists/List.js');
include(dataModelsRoot + 'lists/Table.js');

include(dataModelsRoot + 'dates/DateInterval.js');
include(dataModelsRoot + 'dates/DateAxis.js');
include(dataModelsRoot + 'dates/DateList.js');

include(dataModelsRoot + 'geometry/Point.js');
include(dataModelsRoot + 'geometry/Point3D.js');
include(dataModelsRoot + 'geometry/Polygon.js');
include(dataModelsRoot + 'geometry/Polygon3D.js');
include(dataModelsRoot + 'geometry/Polygon3DList.js');
